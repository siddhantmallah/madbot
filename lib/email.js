 ...
 */
export async function sendEmail({ to, subject, html, text, replyTo = CONTACT_EMAIL }) {
 ...
 */
export function buildWelcomeEmail({ name, maxSites, intendedPlanName, trialDays, siteUrl }) {
