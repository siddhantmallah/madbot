...
export const COMPANY = {
  ...
  // (Companies Act 2013, s.12(3)(c)).
  cin: null, // MISSING_FOR_LAUNCH — 21-character CIN from the certificate of incorporation
  pan: null, // MISSING_FOR_LAUNCH — company PAN, needed on invoices
  ...
  registeredOffice: {
    line1: null, // MISSING_FOR_LAUNCH
    line2: null,
    city: null, // MISSING_FOR_LAUNCH
    state: null, // MISSING_FOR_LAUNCH
    postcode: null, // MISSING_FOR_LAUNCH
    country: "India",
  },
...
export function registeredAddressLine() {
  ...
  // Country alone is not an address.
...
export function missingForLaunch() {
  ...
  if (!registeredAddressLine()) out.push("Registered office address");
