...
export const PLANS = {
  // What you get before buying anything. Deliberately enough to prove MADBOT
  // reads your site correctly, and not enough to run a business on.
  trial: {
    id: "trial",
    name: "No plan yet",
    price: 0,
...
export const PLAN_ORDER = ["trial", "scout", "madbot", "swarm"];

export const TRIAL_DAYS = 14;

// Every trial runs at MADBOT level whatever plan was clicked. A Scout-shaped
// trial would never show content, leads or AI visibility, which leaves nothing
// to upgrade to — and the free public report already covers the audit, so a
// feature-limited free tier demonstrates nothing new.
export const TRIAL_PLAN = "madbot";
