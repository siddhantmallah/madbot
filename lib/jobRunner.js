  ...
  async [JOB_TYPES.CRAWL_SITE](job, { step }) {
    ...
    return {
      result: {
        ...
        totalWords: crawl.stats.totalWords,
        orphanPages: crawl.stats.orphanPages.length,
        brokenLinks: crawl.stats.brokenLinks,
        elapsedMs: crawl.stats.elapsedMs,
      },
      summary: `Crawled ${crawl.stats.pagesCrawled} pages (${crawl.stats.discovered} discovered), ${crawl.stats.totalWords.toLocaleString()} words`,
      writes: {
        site: {
          intelligence: intel,
      ...
      activity: {
        k: "seo",
        text: `Crawled ${crawl.stats.pagesCrawled} pages on ${intel.domain} and built its profile`,
        why: `Discovered ${crawl.stats.discovered} URLs; read ${crawl.stats.totalWords.toLocaleString()} words`,
        result: `${crawl.stats.pagesCrawled} pages`,
      },
    };
  },
